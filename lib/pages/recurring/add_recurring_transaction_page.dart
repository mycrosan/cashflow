...
class _AddRecurringTransactionPageState extends State<AddRecurringTransactionPage> {
  ...
  Future<void> _updateHomeData() async {
    try {
      ...
      print('=== ADD RECURRING: Atualizando dados da tela inicial ===');
      ...
      print('=== ADD RECURRING: Dados da tela inicial atualizados com sucesso ===');
    } catch (e) {
      print('=== ADD RECURRING: Erro ao atualizar dados da tela inicial ===');
      print('Erro: $e');
    }
  }
